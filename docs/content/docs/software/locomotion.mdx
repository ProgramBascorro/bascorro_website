...
<Callout type="warn">
  Gain yang terlalu tinggi menyebabkan oscillation. Gain terlalu rendah
  menyebabkan robot tidak stabil. Tuning harus dilakukan dengan hati-hati.
</Callout>
...
**Link:** [Locomotion Fundamentals](/docs/learning/motion)
