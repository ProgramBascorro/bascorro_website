...
export default function TeamPreview() {
  ...
  const advisorMembers = leadMembers.filter((m) => m.division === "Advisor");
  const teamLeads = leadMembers.filter((m) => m.division !== "Advisor");
  ...
  return (
    <section id="team" className="py-24 px-8 bg-white border-t border-gray-100">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Divisions Grid */}
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 md:gap-6 mb-20">
