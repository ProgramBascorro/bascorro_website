...
#ifndef BALL_TRACKING_HPP_
#define BALL_TRACKING_HPP_
...
protected:
  ...
  void ballPositionCallback(const op3_ball_detector::msg::CircleSetStamped::SharedPtr msg);
  ...
  rclcpp::Publisher<std_msgs::msg::String>::SharedPtr head_joint_offset_pub_;
