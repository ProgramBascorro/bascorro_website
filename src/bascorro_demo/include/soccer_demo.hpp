...
#ifndef SOCCER_DEMO_HPP_
#define SOCCER_DEMO_HPP_
...
#include "robotis_controller_msgs/msg/set_joint_module.hpp"
...
class SoccerDemo : public OPDemo
{
 ...
 protected:
  ...
  rclcpp::Publisher<std_msgs::msg::String>::SharedPtr rgb_led_pub_;
